...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='continued',
            field=models.BooleanField(default=True, help_text='If False the change is valid for one day.'),
        ),
        migrations.AlterField(
            model_name='changelogging',
            name='until',
            field=models.DateField(help_text='The last day the change is valid. Can be blank.', null=True, blank=True),
        ),
        migrations.AddField(
            model_name='ward',
            name='ward_type',
