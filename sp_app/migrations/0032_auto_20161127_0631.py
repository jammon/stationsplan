...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='changelogging',
            options={'verbose_name': '\xc4nderung', 'verbose_name_plural': '\xc4nderungen'},
        ),
        migrations.AlterModelOptions(
            name='employee',
        ...
        migrations.AddField(
            model_name='planning',
            name='superseded_by',
            field=models.ForeignKey(related_name='supersedes', on_delete=django.db.models.deletion.SET_NULL, default=None, blank=True, to='sp_app.Planning', help_text='Later planning that supersedes this one', null=True),
        ),
        migrations.AlterField(
            model_name='person',
            name='anonymous',
            field=models.BooleanField(default=False, help_text='wenn Wahr, dann steht diese Person f\xfcr mehrere andere Personen, z.B. eine Abteilung', verbose_name='Anonym'),
        ),
        migrations.AlterField(
